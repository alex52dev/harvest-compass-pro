...
export default function FarmsPage() {
  ...
  const filtered = mockFarms.filter(
    (f) => f.location.toLowerCase().includes(search.toLowerCase())
  );

  const getFarmerName = (farmerId: number) => mockFarmers.find((f) => f.farmerId === farmerId)?.name || "Unknown";
